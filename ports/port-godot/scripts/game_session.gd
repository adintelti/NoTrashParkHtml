	...
	match language_code:
		"en":
			return {
				...
				"gameOver.summary": "The park ran out of lives. Session summary:",
				...
				"pause.restartConfirm": "Are you sure you want to restart the game?",
		...
		"es":
			return {
				...
				"gameOver.summary": "El parque se quedo sin vidas. Resumen de la sesion:",
				...
				"pause.restartConfirm": "Estas seguro de que quieres reiniciar el juego?",
		...
		_:
			return {
				...
				"gameOver.summary": "O parque ficou sem vidas. Resumo da sessão:",
				...
				"pause.restart": "Reiniciar",
				"pause.restartConfirm": "Você tem certeza de que quer reiniciar o jogo?",
