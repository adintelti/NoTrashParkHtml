	...
	match language_code:
		"en":
			return {
				...
				"cards.kicker": "Wave event",
				"cards.kind.bane": "Risk",
				"cards.kind.boon": "Help",
		...
		"es":
			return {
				...
				"cards.kicker": "Evento de oleada",
				"cards.kind.bane": "Riesgo",
				"cards.kind.boon": "Ayuda",
		...
		_:
			return {
				...
				"cards.kicker": "Evento da onda",
				"cards.kind.bane": "Risco",
				"cards.kind.boon": "Ajuda",
				"cards.kind.neutral": "Neutro",
